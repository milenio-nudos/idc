### 10.08-2025 Preparation 2025 educational dimension data
...
docente_lect_2m <- read.csv(here("data", "raw_data", "c_educativo", "2024_2m_docente_lect.csv"), sep = ";", fileEncoding = "UTF-8")
docente_mate_2m <- read.csv(here("data", "raw_data", "c_educativo", "2024_2m_docente_mate.csv"), sep = ";", fileEncoding = "UTF-8")
docente_6b      <- read.csv(here("data", "raw_data", "c_educativo", "2024_6b_docente.csv"), sep = ";", fileEncoding = "UTF-8")
docente_4b      <- read.csv(here("data", "raw_data", "c_educativo", "2024_4b_docente.csv"), sep = ";", fileEncoding = "UTF-8")

# Import RBD SIMCE
simce_rbd_2m <- read.csv(here("data", "raw_data", "c_educativo", "2024_2m_rbd.csv"), sep = ";", fileEncoding = "UTF-8")
simce_rbd_6b <- read.csv(here("data", "raw_data", "c_educativo", "2024_6b_rbd.csv"), sep = ";", fileEncoding = "UTF-8")
simce_rbd_4b <- read.csv(here("data", "raw_data", "c_educativo", "2024_4b_rbd.csv"), sep = ";", fileEncoding = "UTF-8")
...
# Select the columns we will work (cdoce_p15 battery) and create new objects
