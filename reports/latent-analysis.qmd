...
#LPA estimation
results_lpa_2025 <- idc %>%
  select(a_indice_2025, b_indice_2025, c_indice_2025) %>%
  filter(complete.cases(a_indice_2025, b_indice_2025, c_indice_2025)) %>%
  mutate(
    a_indice_2025 = as.numeric(a_indice_2025),
    b_indice_2025 = as.numeric(b_indice_2025),
    c_indice_2025 = as.numeric(c_indice_2025)
  )  %>%
  estimate_profiles(1:10,  # número de clases a probar (puedes ajustar)
